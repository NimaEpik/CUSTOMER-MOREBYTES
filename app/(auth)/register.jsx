...
function FieldError({ message }) {
  ...
  return <View style={styles.fieldError}><Ionicons name="warning-outline" size={14} color="#D94343" /><Text style={styles.fieldErrorText}>{message}</Text></View>;
}
...
export default function RegisterScreen() {
  ...
  return <SafeAreaView style={styles.container}><ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
    ...
    {generalError ? <View style={styles.errorBanner}><Ionicons name="warning-outline" size={18} color="#D94343" /><Text style={styles.bannerText}>{generalError}</Text></View> : null}
    <Text style={styles.label}>FULL NAME</Text><View style={inputStyle("fullName")}><TextInput style={styles.input} placeholder="John Doe" placeholderTextColor="#9CA3AF" value={fullName} onChangeText={setFullName} onFocus={() => setFocusedField("fullName")} onBlur={() => setFocusedField("")} /></View><FieldError message={errors.fullName} />
    <Text style={styles.label}>PHONE NUMBER</Text><View style={inputStyle("phone")}><TextInput style={styles.input} placeholder="09XX XXX XXXX" placeholderTextColor="#9CA3AF" keyboardType="phone-pad" value={phone} onChangeText={setPhone} onFocus={() => setFocusedField("phone")} onBlur={() => setFocusedField("")} /></View><FieldError message={errors.phone} />
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#ECECEC" }, scrollContent: { flexGrow: 1, paddingHorizontal: 28, paddingTop: 60, paddingBottom: 28 }, title: { color: "#121212", fontFamily: FONT, fontSize: 32, fontWeight: "700" }, subtitle: { color: "#8F8F8F", fontFamily: FONT, fontSize: 14, marginTop: 6 }, divider: { height: 1, backgroundColor: "#F0F0F0", marginTop: 16 },
  errorBanner: { backgroundColor: "#FDEDEC", borderColor: "#F5C6CB", borderRadius: 12, borderWidth: 1, flexDirection: "row", gap: 10, marginTop: 18, padding: 14 }, bannerText: { color: "#9B2C2C", flex: 1, fontFamily: FONT, fontSize: 13, lineHeight: 18 }, label: { color: "#4B4B4B", fontFamily: FONT, fontSize: 12, fontWeight: "600", letterSpacing: 0.3, marginBottom: 8, marginTop: 16 },
  inputWrap: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#D4D4D4", borderRadius: 10, borderWidth: 1, flexDirection: "row", minHeight: 50, paddingHorizontal: 14 }, focusedInput: { borderColor: "#F97000" }, errorInput: { backgroundColor: "#FFF3F2", borderColor: "#D94343" }, input: { color: "#121212", flex: 1, fontFamily: FONT, fontSize: 14, paddingVertical: 11 }, fieldError: { alignItems: "center", flexDirection: "row", gap: 6, marginTop: 7 }, fieldErrorText: { color: "#D94343", fontFamily: FONT, fontSize: 12 },
  strengthRow: { alignItems: "center", flexDirection: "row", gap: 10, marginTop: 7 }, strengthTrack: { backgroundColor: "#E5E7EB", borderRadius: 2, flex: 1, height: 3, overflow: "hidden" }, strengthFill: { borderRadius: 2, height: "100%" }, strengthText: { fontFamily: FONT, fontSize: 12, fontWeight: "600", width: 48, textAlign: "right" }, primaryButton: { alignItems: "center", backgroundColor: "#F97000", borderRadius: 9, height: 54, justifyContent: "center", marginTop: 22 }, primaryText: { color: "#FFFFFF", fontFamily: FONT, fontSize: 18, fontWeight: "700" }, loginRow: { alignItems: "center", flexDirection: "row", justifyContent: "center", marginTop: "auto", paddingTop: 42 }, loginText: { color: "#8A8A8A", fontFamily: FONT, fontSize: 12 }, loginLink: { color: "#F97000", fontFamily: FONT, fontSize: 12, fontWeight: "700" },
});
